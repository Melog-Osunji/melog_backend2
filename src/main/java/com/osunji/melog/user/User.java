...
public class User {
    ...
    //생성자 - 필수 정보로만 이루어짐
    public User(String email, String platform) {
        this.email = email;
        this.platform = platform;
    }

    //생성자 - uuid제외 전체 정보로 생성
    public User(String email, String platform, String nickname,
    ...
    // 메서드 1 - 회원가입용 (최소 정보)
    public static User createNewUser(String email, String platform) {
