...
public class PostReport {
    ...
    public static com.osunji.melog.harmony.entity.HarmonyRoomReport create(User reporter, HarmonyRoom harmonyRoom,
                                                                           String reason, String category, String details) {
        com.osunji.melog.harmony.entity.HarmonyRoomReport report = new com.osunji.melog.harmony.entity.HarmonyRoomReport();
